...
do
    ...
    do
        ...
        python scoring_exp/make-aes-cfact-fewshot-requests.py \
            --essay-dir data/${dataset_name}/test.jsonl \
            --id-field ${ID_FIELD} \
            --text-field ${TEXT_FIELD} \
            --prompt-dir prompts/scoring/${dataset_name} \
            --model-id "${model_name}" \
            --output-file requests/scoring/${dataset_name}/fewshot/original_${model_short_name}_${today}.jsonl \
            --fewshot_dict "data/${dataset_name}/medoids_dict.json" \
        ...
        do
            ...
            python scoring_exp/make-aes-cfact-fewshot-requests.py \
                ...
                --prompt-dir prompts/scoring/${dataset_name} \
                --model-id "${model_name}" \
                --output-file requests/scoring/${dataset_name}/fewshot/${strategy}_${model_short_name}_${today}.jsonl \
                --fewshot_dict "data/${dataset_name}/medoids_dict.json" \
                --dataset ${dataset_name}
        done
